...
const photos: Photo[] = [
  {
    ...
    description: "Like this beautiful sunset, your love lights up my entire world with warmth and hope."
  },
  {
    id: 2,
    src: "https://images.unsplash.com/photo-1715111965684-e2cdde4a1f5c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3RoZXIlMjBkYXVnaHRlciUyMGhhbmRzJTIwaGVhcnQlMjBzaGFwZXxlbnwxfHx8fDE3NTc5NjY2OTJ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    alt: "Hands forming heart shape",
    title: "Heart to Heart",
    description: "Our bond is stronger than words - it's written in every gesture, every touch, every shared moment."
  },
  {
    id: 3,
    ...
    description: "Just like these flowers bloom in spring, your love has helped me blossom into who I am today."
  },
  {
    id: 4,
    ...
    description: "Our dreams float together like these clouds - beautiful, endless, and always reaching higher."
  },
  {
    id: 5,
    ...
    description: "No matter where life takes me, home will always be wherever you are, Mom."
  }
];
  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-4">
        ...
        <p className="text-gray-600 text-sm sm:text-base">Visual stories of love, dreams, and beautiful moments</p>
      </div>
          ...
          >
            ...
            >
              ...
              <div className="p-4 space-y-2">
                <h3 className="text-gray-800 text-lg">{photo.title}</h3>
                <p className="text-gray-600 text-sm leading-relaxed line-clamp-2">{photo.description}</p>
            ...
            >
              ...
              <div className="p-6 space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-xl text-gray-800">{selectedPhoto.title}</h3>
                </div>
                <p className="text-gray-600 leading-relaxed">{selectedPhoto.description}</p>
              </div>
            </motion.div>
          </motion.div>
        )}
